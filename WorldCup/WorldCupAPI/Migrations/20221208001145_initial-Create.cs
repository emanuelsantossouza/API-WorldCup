    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_World Cup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_World Cup_Country_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorldCupCountry_World Cup_WorldCupId",
                        column: x => x.WorldCupId,
                        principalTable: "World Cup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorldCupCountryPlayer_World Cup_WorldCupId",
                        column: x => x.WorldCupId,
                        principalTable: "World Cup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
